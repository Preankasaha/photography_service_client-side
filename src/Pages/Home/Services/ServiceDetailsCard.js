        ...
        <div>
            ...
            <div className='bg-fuchsia-900'>
                <div className='glass p-8 my-8'>
                    ...
                    <p className='text-xl text-white'>Please give your review, whether positive or negetive, regaring my service. You are highly recommended to remain true to your feeling ragarding my service. Your valuable review will help me to enhance the quality of my service.</p>
