        ...
        <div className='bg-fuchsia-900 py-8'>
            ...
            <div className='grid md:grid-cols-2 justify-around'>
                ...
                <div className='text-white bg-fuschia-900 text-left'>
                    <h2 className='text-2xl my-4'>Hello, This is Photographer Artison with you!</h2>
                    ...
                    <p className='text-2xl my-4'>Besides phopgraphy, I also photography courses. You can avail any one of the course if you feel enthusiast</p>
